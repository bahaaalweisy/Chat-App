    ...
    <form action="" method="post" enctype="multipart/form-data">
          <table class="table table-bordered table-hover">
            ...
            <tr>
              ...
              <td>
              <input class="form-control" type="password" name="pass1" id="mypass" required="required" placeholder="New Password" />
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
              <input class="form-control" type="password" name="pass2" id="mypass" required="required" placeholder="Confirm Password" />
              </td>
            </tr>
        ...
        include_once ('db.php');
          ...
          if(isset($_POST['change'])){
              ...
              $get_pass = "select * from user where userName='$userName'";
              ...
              if($pass1 == $pass2 AND $c_pass == $password){
                $update_pass = mysqli_query($con, "UPDATE user SET password='$pass1' WHERE userName='$user'");
                echo"
                  <div class='alert alert-danger'>
